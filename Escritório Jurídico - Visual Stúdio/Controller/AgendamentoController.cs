...
using Escritório_Jurídico___Visual_Stúdio.Repositorio;
...
namespace Escritório_Jurídico___Visual_Stúdio.Controllers
{
    public class AgendamentoController : Controller
    {
        ...
        public AgendamentoController(AgendamentoRepositorio agendamentoRepositorio, PotereDeMeritisContext context)
        {
        ...
        public IActionResult Index()
        {
            ...
            var atendimentos = _agendamentoRepositorio.ListarAgendamento();
